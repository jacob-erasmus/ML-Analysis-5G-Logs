...
threshold_mse = np.percentile(train_mse, 99)
print(f"    [>] Autoencoder trained. Reconstruction error threshold locked at: {threshold_mse:.4f}")
# -------------------------------------------------------------
...
l1_binary_flags = (test_mse > threshold_mse).astype(int)
